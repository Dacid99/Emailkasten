...
"""Test module for :mod:`api.serializers.EMailCorrespondentsSerializers.BaseEMailCorrespondentSerializer`."""
...
from api.serializers.emailcorrespondents_serializers.BaseEMailCorrespondentSerializer import \
