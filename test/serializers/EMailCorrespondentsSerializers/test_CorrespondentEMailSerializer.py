...
"""Test module for :mod:`api.serializers.EMailCorrespondentsSerializers.CorrespondentEMailSerializer`."""
...
from api.serializers.emailcorrespondents_serializers.CorrespondentEMailSerializer import \
