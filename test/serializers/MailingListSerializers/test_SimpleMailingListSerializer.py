...
"""Test module for :mod:`api.serializers.MailingListSerializers.SimpleMailingListSerializer`."""
...
from api.serializers.mailinglist_serializers.SimpleMailingListSerializer import \
