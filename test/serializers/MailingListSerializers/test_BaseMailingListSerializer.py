...
"""Test module for :mod:`api.serializers.MailingListSerializers.BaseMailingListSerializer`."""
...
from api.serializers.mailinglist_serializers.BaseMailingListSerializer import \
