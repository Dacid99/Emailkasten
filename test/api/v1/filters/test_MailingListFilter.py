...
"""Test module for :class:`api.v1.filters.MailingListFilterSet`."""

import pytest

from api.v1.filters import MailingListFilterSet
...
def test_list_id_filter(
    ...
    """Tests :class:`api.v1.filters.MailingListFilterSet`'s filtering
