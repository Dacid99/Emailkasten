...
```bash
sudo apt-get -y update && apt-get -y install build-essential default-mysql-client krb5-user krb5-multidev libmysqlclient-dev pkg-config mysql-server nodejs npm
```
